...
// Macro options
let ItemBrightLight = 4.5;
let ItemDimLight = 13.5;
let ItemAnimationType = "torch";
let ItemLightColor = "#ffae00";
let ItemLightAlpha = 0.4;
let ItemUnlitImage = "icons/sundries/lights/lantern-steel.webp";
let ItemLitImage = "icons/sundries/lights/lantern-iron-lit-yellow.webp";
let ItemTaggerHelper = "normal_lamp_lit";
